...
// intersection elements to output buffers. Used by ECLAT v2 where
...
@group(0) @binding(6) var<storage, read> wgInfo: array<u32>;
@group(0) @binding(7) var<storage, read> pairIdPerWg: array<u32>;
@group(0) @binding(8) var<storage, read> pairOutputOffsetPerWg: array<u32>;
@group(0) @binding(9) var<uniform> totalWg_uniform: u32;
...
fn decoupled_lookback_batched_kernel(
    ...
    // ========================================================================
    let pair_output_offset = pairOutputOffsetPerWg[block];
