...
export class GPUSorter {
    ...
    public async sort(queue: GPUQueue, sortBuffers: SortBuffers, sortFirstN?: number, baseIndex: number = 0) {
        ...
        this.recordCalculateHistogram(commandEncoder, sortBuffers.bindGroup, numElements, this.timestampQueryManager, base + 0);
        this.recordPrefixHistogram(commandEncoder, sortBuffers.bindGroup, this.timestampQueryManager, base + 4);
        this.recordScatterKeys(commandEncoder, sortBuffers.bindGroup, numElements, this.timestampQueryManager, base + 6);
