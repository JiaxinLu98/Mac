// ============================================================================
// Set Availability - Union with Decoupled Lookback - SENTINEL
//
...
// 4. Each thread runs SerialSetUnion to get results
...
//
// For multiset union (A U B): emit every element from merged sequence
...
// ============================================================================
// Serial Set Union - with sentinel offset
...
//
// Union always emits: pB → emit B; otherwise → emit A (includes tie case)
// ============================================================================
fn serial_set_union(
    a_begin: u32,
    a_end: u32,
    ...
    for (var i: u32 = 0u; i < VT; i++) {
        ...
        // Union output: pB → emit B; otherwise → emit A (includes A < B and A == B)
