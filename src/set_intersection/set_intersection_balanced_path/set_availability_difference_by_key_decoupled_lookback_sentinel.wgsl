// ============================================================================
// Set Availability - Difference By Key with Decoupled Lookback - SENTINEL
//
...
// 4. Each thread runs SerialSetDifferenceByKey to get results
...
// ============================================================================
// Serial Set Difference By Key - with sentinel offset
// Branchless select() for pointer advancement + pre-fetch pattern.
// Physical indices are +1 from logical indices.
//
// When A_key < B_key (pA), store A's key and A's value (Thrust semantics).
//
// With sentinels, boundary handling is automatic:
// - A exhausted -> a_key = POS_INF -> pA=false, pB=true -> B advances, no emit
// - B exhausted -> b_key = POS_INF -> pA=true, pB=false -> A emits, A advances
...
fn difference_by_key_decoupled_lookback(
    ...
    // ========================================================================
    // Step 4: Serial set difference by key
    // ========================================================================
