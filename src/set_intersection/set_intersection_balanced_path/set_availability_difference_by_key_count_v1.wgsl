// ============================================================================
// Set Availability - Difference By Key Count Kernel (Strategy A / v1)
//
...
fn serial_set_difference_by_key(
    ...
    for (var i: u32 = 0u; i < VT; i++) {
        ...
        if (!extended) {
            ...
            if (b_idx >= b_end) {
                // B exhausted, emit A and advance A
        ...
        // Always store results at position i (sparse storage)
        (*results)[i] = a_key;
        (*indices)[i] = a_idx;
...
// ============================================================================
// Main Kernel: Count Difference By Key
// ============================================================================
