// ============================================================================
// Set Availability - Symmetric Difference Write Kernel (Strategy A / v1)
//
...
// ============================================================================
// Serial Set Symmetric Difference (ModernGPU Style)
//
...
fn workgroup_exclusive_scan(tid: u32, value: u32) -> u32 {
    ...
    let inclusive = shared_scan[tid];
    workgroupBarrier();

    if (tid == 0u) {
        shared_scan[tid] = 0u;
    } else {
        shared_scan[tid] = shared_scan[tid - 1u];
    }
    workgroupBarrier();
...
// ============================================================================
// Main Kernel: Write Symmetric Difference
// ============================================================================
