// ============================================================================
// Set Availability - Intersection Write Kernel (Strategy A / v1) - OPTIMIZED
//
...
//
// Optimizations applied (matching count kernel):
...
// Processes elements serially, returning a commit bitmask and storing results.
