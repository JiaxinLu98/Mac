// ============================================================================
// Set Availability - Intersection Count Kernel (Strategy A / v1) - SENTINEL
//
...
// ============================================================================
// Serial Set Intersection (ModernGPU Style) - with sentinel offset
//
...
fn count_availability(
    ...
    //   but we pass logical b0tid and the function adds b_start internally via b_begin
    //
    // Actually, looking at the original code, b_begin = b_start + b0tid (physical)
    // and b_end = b_start + b_count2 (physical)
    // In serial_set_intersection, we access keys_shared[b_idx] directly
    // So b_idx is already physical. We just need to add +1 for sentinel.
